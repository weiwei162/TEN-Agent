...
from .dashscope import DashScopeImageGenerateClient, DashScopeImageGenerateToolConfig

class DashScopeImageGenerateToolExtension(AsyncLLMToolBaseExtension):
    ...
    async def on_start(self, ten_env: AsyncTenEnv) -> None:
        ...
        self.config = await DashScopeImageGenerateToolConfig.create_async(ten_env=ten_env)
        ...
        self.client = DashScopeImageGenerateClient(ten_env, self.config)
